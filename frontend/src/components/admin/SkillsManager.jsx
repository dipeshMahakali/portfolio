  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h2 className="text-2xl md:text-3xl font-bold text-white">Skills Management</h2>
        <Button
          onClick={handleSave}
          disabled={saving}
      ...
      <div className="grid grid-cols-1 gap-4">
        {skills.map((skill, index) => (
          <Card key={index} className="p-4 bg-gradient-to-br from-blue-900/20 to-cyan-900/20 border-blue-500/20">
