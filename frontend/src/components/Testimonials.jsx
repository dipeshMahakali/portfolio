          ...
          >
            {[...testimonials, ...testimonials].map((testimonial, index) => (
              <Card
                ...
                className="flex-shrink-0 w-[400px] p-8 bg-gradient-to-br from-purple-900/20 to-blue-900/20 border-purple-500/20 hover:border-purple-500/40 transition-all duration-300"
              >
